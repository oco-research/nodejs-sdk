...
let apiInstance = new PetStoreNodeJsSdk.PetApi();
let pet = new PetStoreNodeJsSdk.Pet(); // Pet | Create a new pet in the store
...
let apiInstance = new PetStoreNodeJsSdk.PetApi();
let pet = new PetStoreNodeJsSdk.Pet(); // Pet | Update an existent pet in the store
